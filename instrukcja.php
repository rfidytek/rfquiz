...
<body>
	<div class="tresc-alt">
		...
		<div class="margines">
			...
			*.txt, czyli utworzonego na przykład w notatniku) lub poprzez pisanie pytań w odpowiednim polu
			edytora online (sposób niezalecany - w przypadku utracenia połączenia z siecią Internet można utracić wprowadzone pytania).</p>
			...
			<p>Treść pytania jednokrotnego lub wielokrotnego wyboru może składać się z jednej lub wielu linii tekstu.<br>
			Każda poprawna odpowiedź musi być poprzedzona znakami "<b>1|</b>", a niepoprawna odpowiedź musi być poprzedzona znakami "<b>0|</b>".<br>
			...
			<p>Są to pytania, na które należy odpowiedzieć poprzez napisanie krótkiego tekstu. Muszą posiadać co najmniej jedną odpowiedź poprawną i mogą posiadać dowolną ilość odpowiedzi częściowo poprawnych.<br> 
			Odpowiedzi prawidłowe powinny zostać poprzedzone znakami "100%|", natomiast jeśli odpowiedź jest częściowo poprawna np. w 50%, to powinna zostać poprzedzona znakami "50%|". Każda odpowiedź powinna zostać umieszczona w osobnej linii.
			</p>
			...
			<p>Pytania zagnieżdzone umożliwiają umieszczenie w tekście pytań z krótką odpowiedzią lub listy rozwijanej z jedną poprawną odpowiedzią.<br>
			Pytania z krótką odpowiedzią powinny zostać umieszczone w tekście w formacie "<b> |odpowiedź| </b>".<br>
			Listy rozwijane z jedną poprawną odpowiedzią powinny być umieszczone w tekście w formacie "<b> |odp. poprawna|odp. niepoprawna 1|odp. niepoprawna 2|odp. niepoprawna n| </b>".<br>
